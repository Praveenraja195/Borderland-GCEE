...
class MindmazeRound(Base):
    __tablename__ = "mindmaze_rounds"
...
class MindmazeResult(Base):
    __tablename__ = "mindmaze_results"
    ...
    round_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey("mindmaze_rounds.round_id", ondelete="CASCADE"), nullable=False
    )
    ...
    correct_tiles: Mapped[int] = mapped_column(Integer, nullable=False)
